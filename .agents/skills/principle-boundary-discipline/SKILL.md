...
description: Enforce validation and error handling at system boundaries while keeping internal logic in pure functions. Use when designing validation, error handling, or framework adapters.
